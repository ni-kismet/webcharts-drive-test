...
function GlPlotter() {
    ...
    this.init = function(plot) {
        ...
        function clear() {
            // Clearing the canvas is an expensive operation so we must be sure
            //there is something to be cleared.
        ...
        function mustDrawSeriesWithGl(serie) {
            return serie.points.glshow || (serie.points.show && isGlRequested());
        }
