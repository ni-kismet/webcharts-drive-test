...
module.exports = function (config) {
    ...
    var coverage_sources = [
        'sources/niComplex.js',
        'sources/niTimeStamp.js',
        'sources/niAnalogWaveform.js',
        'sources/niNumericFormatters.js',
        'sources/niType.js'
    ];

    var sources = coverage_sources.concat([
        'tests/resources/niTypeTestTypes.js',
    ]);
    ...
    if (config.coverage) {
        ...
        //settings.reporters.push('coveralls'); // enable this when we'll want coveralls support 
    }
