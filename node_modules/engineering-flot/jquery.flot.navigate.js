...
(function($) {
    ...
    function init(plot) {
        ...
        function onZoomPinch(e, zoomOut) {
            var c = plot.offset(),
                pageX = (e.originalEvent.touches[0].pageX + e.originalEvent.touches[1].pageX) / 2,
                pageY = (e.originalEvent.touches[0].pageY + e.originalEvent.touches[1].pageY) / 2;
            c.left = pageX - c.left;
            c.top = pageY - c.top;
            if (zoomOut) {
                plot.zoomOut({
        ...
        function onGestureStart(e, delta) {
            var x = 10;
        }

        function onGestureChange(e, delta) {
            var y = 11;
        }

        function onGestureEnd(e, delta) {
            var z = 12;
        }
        ...
        function isPinchEvent(e) {
            return e.originalEvent.touches && e.originalEvent.touches.length === 2;
        }

        function pinchDistance(e) {
          var o = e.originalEvent,
              dist = Math.sqrt(
                (o.touches[0].clientX-o.touches[1].clientX) * (o.touches[0].clientX-o.touches[1].clientX) +
                (o.touches[0].clientY-o.touches[1].clientY) * (o.touches[0].clientY-o.touches[1].clientY));
            return dist;
        }
        ...
        function bindEvents(plot, eventHolder) {
            ...
            if (o.zoom.interactive) {
                ...
                eventHolder.bind("gesturestart", onGestureStart);
                eventHolder.bind("gesturechange", onGestureChange);
                eventHolder.bind("gestureend", onGestureEnd);
            }
