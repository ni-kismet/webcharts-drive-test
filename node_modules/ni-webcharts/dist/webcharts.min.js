...
NationalInstruments.HtmlVI.Elements.CartesianPlotRenderer=function(){"use strict"},function(t,e){"use strict";var r=NationalInstruments.HtmlVI.NISupport;r.inheritFromParent(t,e);var a=t.prototype;a.addAllProperties=function(t){e.prototype.addAllProperties.call(this,t),a.addProperty(t,{propertyName:"lineStroke",defaultValue:"auto"}),a.addProperty(t,{propertyName:"lineWidth",defaultValue:1}),a.addProperty(t,{propertyName:"lineStyle",defaultValue:"solid"}),a.addProperty(t,{propertyName:"areaFill",defaultValue:""}),a.addProperty(t,{propertyName:"areaBaseLine",defaultValue:"zero"}),a.addProperty(t,{propertyName:"barFill",defaultValue:""}),a.addProperty(t,{propertyName:"pointColor",defaultValue:""}),a.addProperty(t,{propertyName:"pointSize",defaultValue:5}),a.addProperty(t,{propertyName:"pointShape",defaultValue:"ellipse"})},a.createdCallback=function(){e.prototype.createdCallback.call(this),this._parentPlot=void 0},a.sendEventToParentPlot=function(t){var e;void 0!==this._parentPlot&&(e={bubbles:!1,cancelable:!0,detail:{element:this}},this._parentPlot.dispatchEvent(new CustomEvent(t,e)))},a.attachedCallback=function(){var t=e.prototype.attachedCallback.call(this);return this.parentElement instanceof NationalInstruments.HtmlVI.Elements.CartesianPlot?(this._parentPlot=this.parentElement,this.sendEventToParentPlot("ni-cartesian-plot-renderer-attached")):(r.error("Plot renderer with following id does not have a parentPlot",this.niControlId),this._parentPlot=void 0),t},a.propertyUpdated=function(t){e.prototype.propertyUpdated.call(this,t),this.sendEventToParentPlot("ni-cartesian-plot-renderer-changed")},a.detachedCallback=function(){e.prototype.detachedCallback.call(this),this.sendEventToParentPlot("ni-cartesian-plot-renderer-detached")},a.toFlotLineStyle=function(t){switch(t){case"solid":return;case"dot":return[this.lineWidth,2*this.lineWidth];case"mediumdash":return[3*this.lineWidth,2*this.lineWidth];case"dashdot":return[3*this.lineWidth,2*this.lineWidth,this.lineWidth,2*this.lineWidth];case"largedash":return[5*this.lineWidth,3*this.lineWidth];default:return}};var i=.6;a.getColor=function(){var t=this.lineStroke||this.pointColor||this.areaFill||this.barFill;return"auto"===t?null:t},a.getViewConfig=function(){return{color:this.getColor(),lines:{show:""!==this.lineStroke||""!==this.areaFill,lineWidth:this.lineWidth,fill:""!==this.areaFill&&i,zero:!1,dashes:this.toFlotLineStyle(this.lineStyle)},points:{show:""!==this.pointColor,radius:this.pointSize?this.pointSize/2:2,symbol:this.pointShape},bars:{show:""!==this.barFill,barWidth:.75,align:"center",zero:!1}}},a.defineElementInfo(a,"ni-cartesian-plot-renderer","HTMLNICartesianPlotRenderer")}(NationalInstruments.HtmlVI.Elements.CartesianPlotRenderer,NationalInstruments.HtmlVI.Elements.Visual);
