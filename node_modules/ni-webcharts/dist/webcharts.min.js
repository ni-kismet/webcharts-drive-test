!function(){"use strict";NationalInstruments.HtmlVI.DataPipeline={},NationalInstruments.HtmlVI.DataPipeline.decimateAW=function(t,a,n,r){var e=(a-t.start)/t.step,i=(n-t.start)/t.step;return NationalInstruments.HtmlVI.DataPipeline.decimate1D(t,e,i,r)},NationalInstruments.HtmlVI.DataPipeline.decimate1D=function(t,a,n,r){var e,i=0,o=0,c=0,l=r/(n-a),f=t.datapoints.points,s=[],u=!0,m=-(1/0),y=-1,p=1/0,A=-1,b=Math.min(Math.max(0,Math.floor(a)),f.length/2),j=n>0?Math.min(f.length/2,Math.floor(n+2)):0,I=function(){A===y?(s[o]=A,s[o+1]=p,o+=2):(A<y?(s[o]=A,s[o+1]=p,s[o+2]=y,s[o+3]=m):(s[o]=y,s[o+1]=m,s[o+2]=A,s[o+3]=p),o+=4)},h=function(){m=-(1/0),y=-1,p=1/0,A=-1};for(c=j-b,r>c&&(l=1),e=2*b;e<2*j;e+=2)u&&(h(),u=!1),f[e+1]<p&&(A=f[e],p=f[e+1]),f[e+1]>m&&(y=f[e],m=f[e+1]),Math.floor(i)!==Math.floor(i+l)&&(I(),u=!0),i+=l;return u||I(),s},"function"!=typeof ArrayBuffer.isView&&(ArrayBuffer.isView=function(t){var a=["[object Int8Array]","[object Uint8Array]","[object Uint8ClampedArray]","[object Int16Array]","[object Uint16Array]","[object Int32Array]","[object Uint32Array]","[object Float32Array]","[object Float64Array]","[object DataView]"],n=Object.prototype.toString.call(t);return a.indexOf(n)!==-1})}();
