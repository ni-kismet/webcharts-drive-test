...
!function(){"use strict";NationalInstruments.HtmlVI.TaskTracker=function(t,e){var n=function(t,e){var n,a=Object.keys(t);if("function"!=typeof e)throw new Error("Completion callback function must be provided");if(a.length<1)throw new Error("Must provide an object with at least one property to use as task names");for(n=0;n<a.length;n+=1)if(t[a[n]]!==a[n])throw new Error("Task name properties and values must be identical; the task names object must be an enum style object");return a};this.remainingTasks=n(t,e),this.taskNames=t,this.completionCallback=e};var t=NationalInstruments.HtmlVI.TaskTracker.prototype;t.complete=function(t){var e;if(void 0===this.taskNames[t])throw new Error("Attempted to complete the following invalid task: "+t);if(0!==this.remainingTasks.length){for(e=0;e<this.remainingTasks.length;e+=1)if(this.remainingTasks[e]===t){this.remainingTasks.splice(e,1);break}0===this.remainingTasks.length&&this.completionCallback.call(void 0)}}}();
!function(n){"use strict";var e=NationalInstruments.HtmlVI.NISupport;window.NIEmbeddedBrowser={},window.NIEmbeddedBrowser.language="en-US",window.NIEmbeddedBrowser.formatLanguage="en-US",e.i18n=void 0,e.InternationalizationInitializer={},e.InternationalizationInitializer.TaskTrackerEnum=Object.freeze({LANGUAGES_LOADED:"LANGUAGES_LOADED",ELEMENT_PROTOTYPES_READY:"ELEMENT_PROTOTYPES_READY"}),e.InternationalizationInitializer.TaskTracker=new NationalInstruments.HtmlVI.TaskTracker(e.InternationalizationInitializer.TaskTrackerEnum,function(){NationalInstruments.HtmlVI.Elements.NIElement._registerElements()});var i=e.InternationalizationInitializer.TaskTrackerEnum,a=e.InternationalizationInitializer.TaskTracker;n.i18n.properties({name:"Messages",language:void 0!==window.engine&&window.engine.IsAttached&&void 0!==window.NIEmbeddedBrowser?window.NIEmbeddedBrowser.language:void 0,path:"Web/Localization/",mode:"map",cache:!0,async:!0,callback:function(){return void 0!==e.i18n?void e.error("The i18n completion callback is being called multiple times"):(e.i18n=function(){return n.i18n.prop.apply(n.i18n,arguments)},void a.complete(i.LANGUAGES_LOADED))}})}(window.jQuery);
!function(){"use strict";NationalInstruments.Globals={},NationalInstruments.Globals.jQuery=$.noConflict(!0)}();
NationalInstruments.HtmlVI.Elements={},NationalInstruments.HtmlVI.Elements.NIElement=function(){"use strict"},function(){"use strict";var e=NationalInstruments.HtmlVI.NISupport,t=function(){var t,r,n,o=[],i=!1;return t=function(e){i===!0?setTimeout(function(){e.call(void 0)},0):o.push(e)},n=function(){var t,r,a,l;for(r in NationalInstruments.HtmlVI.Elements)if(NationalInstruments.HtmlVI.Elements.hasOwnProperty(r)&&(a=NationalInstruments.HtmlVI.Elements[r].prototype,void 0!==a.elementInfo))for(l=document.querySelectorAll(a.elementInfo.tagName),t=0;t<l.length;t+=1)void 0!==l[t]._attachedCallbackFirstCall&&l[t]._attachedCallbackFirstCall!==!0||e.error("Following element not initialized yet, require more robust initialization tracking behavior",l[t]);if(i===!1){for(e.debugVerbose("Running callbacks for event NI Element Event"),t=0;t<o.length;t+=1)o[t].call(void 0);o=[],i=!0}document.removeEventListener("DOMContentLoaded",n)},r=function(){"loading"!==document.readyState?setTimeout(function(){n()},0):document.addEventListener("DOMContentLoaded",n)},{notifyElementsRegistered:r,addCallback:t}}();NationalInstruments.HtmlVI.Elements.NIElement._registerElements=function(){var e,r;for(e in NationalInstruments.HtmlVI.Elements)NationalInstruments.HtmlVI.Elements.hasOwnProperty(e)&&(r=NationalInstruments.HtmlVI.Elements[e].prototype,void 0!==r.elementInfo&&(window[r.elementInfo.prototypeName]=document.registerElement(r.elementInfo.tagName,{prototype:Object.create(r)})));t.notifyElementsRegistered()},NationalInstruments.HtmlVI.Elements.NIElement.addNIEventListener=function(e,r){if("attached"!==e)throw new Error("The following event is not an event supported by ni-element: "+e);if("function"!=typeof r)throw new Error("A valid callback was not provided for ni-element to trigger for the NI Event Listener");t.addCallback(r)}}(),function(e,t){"use strict";var r=NationalInstruments.HtmlVI.NISupport;r.inheritFromParent(e,t);var n=e.prototype,o=0,i=function(){var e={},t=function(t,r,n){void 0===e[t]&&(e[t]={}),e[t][r]=n},r=function(t,r){return void 0===e[t]||void 0===e[t][r]?void 0:e[t][r]},n=function(t){return e[t]};return{addAttributeConfig:t,getAttributeConfig:r,getAttributeList:n}}(),a=function(e,t){var r;if("object"==typeof e){if("object"!=typeof t||null===t)return!1;for(r in e)if(e.hasOwnProperty(r)&&Object.is(e[r],t[r])===!1&&void 0!==t[r])return!1;return!0}return Object.is(e,t)},l=function(e,t,r){var n,o,i,a,l,s;if(1===t.length){if("boolean"===t[0].type)return""===r||r===e||"true"===r;if("number"===t[0].type)return null===r||void 0===r?void 0:parseFloat(r);if("string"===t[0].type)return null===r||void 0===r?void 0:r}else if(t.length>1){try{n=JSON.parse(r)}catch(e){return}if("object"!=typeof n||null===n)return;for(o={},i=0;i<t.length;i+=1)if(l=t[i].propertyName,a=t[i].type,s=typeof n[l],a===s)o[l]=n[l];else if("number"!==a||"string"!==s&&null!==n[l]){if(void 0!==n[l]&&null!==n[l])return;o[l]=void 0}else o[l]=parseFloat(n[l]);return o}},s=function(e){var t=typeof e;if("boolean"===t)return e?"":void 0;if("number"===t)return Object.is(e,-0)?"-0":e.toString();if("string"===t)return e;if("object"===t)return JSON.stringify(e,function(e,t){if("number"==typeof t){if(isFinite(t)===!1)return t.toString();if(Object.is(t,-0))return"-0"}return t});throw new Error(r.i18n("msg_UNKNOWN_TYPE",t))},f=function(e,t,n){var o,i,a,l,s;if(1===e.length){if(typeof n===e[0].type)return n;throw new Error(r.i18n("msg_UNEXPECTED_VALUE",e[0].propertyName,e[0].type))}if("object"!=typeof n||null===n)throw new Error(r.i18n("msg_UNEXPECTED_VALUE",n,"object"));for(o={},i=0;i<e.length;i+=1){if(a=e[i].propertyName,l=e[i].type,s=n[a],void 0===s)s=t[a];else if(typeof s!==l)throw new Error(r.i18n("msg_UNEXPECTED_VALUE",a,l));o[a]=s}return o},u=function(e,t,r){return 1===t.length&&"boolean"===t[0].type&&""!==r&&null!==r},p=function(e,t,r){var n=e.getAttribute(t);return l(t,r,n)},m=function(e,t,r,n){var o=s(n);void 0===o?e.removeAttribute(t):e.setAttribute(t,o)};n.addAllProperties=function(e){},n.createdCallback=function(){var e,t,n,a,l,s;if(r.defineConstReference(this,"niElementInstanceId",o++),void 0!==this._attachedCallbackFirstCall)throw new Error("Created Callback has been invoked multiple times for this element");this._attachedCallbackFirstCall=!0,e=i.getAttributeList(this.elementInfo.tagName);for(t in e)e.hasOwnProperty(t)&&(n=e[t],a=p(this,t,n.typeArray),l=void 0===a?n.defaultValue:f(n.typeArray,n.defaultValue,a),Object.defineProperty(this,n.privatePropertyName,{configurable:!1,enumerable:!1,writable:!0,value:l}),void 0===a?m(this,t,n.typeArray,n.defaultValue):(s=u(t,n.typeArray,this.getAttribute(t)),s&&m(this,t,n.typeArray,a)))},n.attachedCallback=function(){return this._attachedCallbackFirstCall===!0&&(this._attachedCallbackFirstCall=!1,!0)},n.propertyUpdated=function(e){},n.attributeChangedCallback=function(e,t,n){var o,a,s,f,p;if(s=i.getAttributeConfig(this.elementInfo.tagName,e),void 0!==s)return t===n?void r.info("ATTRIBUTE CHANGED CALLBACK FOR ATTRIBUTE "+e+" NEW VALUE ("+n+") EQUAL TO OLD VALUE ("+t+") SO RETURNING"):(f=this.getAttribute(e),f!==n&&(r.info("ATTRIBUTE CHANGED CALLBACK FOR ATTRIBUTE "+e+" NEW VALUE ("+n+") NOT EQUAL TO CURRENT VALUE ("+f+") SO IGNORING NEW VALUE"),n=f),o=l(e,s.typeArray,n),void 0===o?(a=l(e,s.typeArray,t),void(void 0===a?m(this,e,s.typeArray,s.defaultValue):this.setAttribute(e,t))):(p=u(e,s.typeArray,n))?void m(this,e,s.typeArray,o):void(this[s.propertyName]=o))},n.detachedCallback=function(){},n.defineElementInfo=function(e,t,n){var o,a,l,s,f=[];if("string"!=typeof t)throw new Error("A valid string must be provided for the tag name");if("string"!=typeof n)throw new Error("A valid string must be provided for the tag prototype name");if(void 0!==e.elementInfo)throw new Error(r.i18n("msg_ALREADY_DEFINED","elementInfo",t));s={},r.defineConstReference(e,"elementInfo",s),r.defineConstReference(s,"tagName",t),r.defineConstReference(s,"prototypeName",n),e.addAllProperties(e),o=i.getAttributeList(t);for(a in o)o.hasOwnProperty(a)&&(l=o[a],void 0!==l.valuePropertyDescriptor&&f.push(l.valuePropertyDescriptor));if(f.length>1)throw new Error("Only one value property can be defined per element");r.defineConstReference(s,"valuePropertyDescriptor",f[0]),Object.seal(s)},n.addProperty=function(e,t){t="object"!=typeof t||null===t?{}:t;var n,o,l,s,u,p,c,d,E=t.propertyName,y=t.defaultValue,h=typeof y,b=t.fireEvent||!1,v=t.addNonSignalingProperty||!1,N=t.preventAttributeSync||!1,g=t.isElementValueProperty||!1;if("string"!=typeof E||/^[a-z][a-zA-Z]*$/.test(E)===!1)throw new Error(r.i18n("msg_INVALID_FORMAT",E,"ascii alpha camelCase string"));if("string"!==h&&"number"!==h&&"boolean"!==h&&"object"!==h)throw new Error(r.i18n("msg_UNKNOWN_TYPE",h));if("boolean"!=typeof b)throw new Error(r.i18n("msg_UNKNOWN_TYPE",typeof b));if("boolean"!=typeof v)throw new Error(r.i18n("msg_UNKNOWN_TYPE",typeof v));if("boolean"!=typeof N)throw new Error(r.i18n("msg_UNKNOWN_TYPE",typeof N));if("boolean"!=typeof g)throw new Error(r.i18n("msg_UNKNOWN_TYPE",typeof g));if("boolean"===h&&y!==!1)throw new Error(r.i18n("msg_UNEXPECTED_VALUE",y,"false"));if(p=[],"object"===h){if(null===y||Array.isArray(y))throw new Error(r.i18n("msg_UNEXPECTED_VALUE",y,"non-null and non-array"));!function(){var e,t,n={};for(e in y)if(y.hasOwnProperty(e)){if(n[e]=y[e],t=typeof n[e],"boolean"!==t&&"string"!==t&&"number"!==t)throw new Error(r.i18n("msg_UNEXPECTED_VALUE",t,"string, boolean, number"));p.push(Object.freeze({propertyName:e,type:t}))}if(p.length<2)throw new Error(r.i18n("msg_UNEXPECTED_VALUE",p.length,"> 2 properties required"));y=Object.freeze(n)}()}else p.push(Object.freeze({propertyName:E,type:h}));if(Object.freeze(p),n=E.split(/(?=[A-Z])/).join("-").toLowerCase(),o=n+"-changed",l="_"+E,s=E+"NonSignaling",void 0!==e[E])throw new Error(r.i18n("msg_ALREADY_DEFINED",e[E],E));if(void 0!==e[l])throw new Error(r.i18n("msg_ALREADY_DEFINED",e[l],E));if(void 0!==e[s])throw new Error(r.i18n("msg_ALREADY_DEFINED",e[s],E));if(g===!0){if(e.elementInfo.hasOwnProperty("valuePropertyDescriptor"))throw new Error("The value property has already been calculated for this element. To create a value property make sure it is included in the addAllProperties function");d=Object.freeze({propertyName:E,attributeName:n,eventName:b?o:void 0,propertyNameNonSignaling:v?s:void 0})}i.addAttributeConfig(e.elementInfo.tagName,n,Object.freeze({defaultValue:y,typeArray:p,privatePropertyName:l,propertyName:E,valuePropertyDescriptor:d})),u=function(e){var t=function(t){var r;a(this[l],t)||(t=f(p,this[l],t),this[l]=t,N===!1&&m(this,n,p,this[l]),this._attachedCallbackFirstCall===!1&&this.propertyUpdated(E),e===!1&&b===!0&&(r={},r[E]=t,this.dispatchEvent(new CustomEvent(o,{bubbles:!0,cancelable:!1,detail:r}))))};try{Object.defineProperty(t,"name",{value:"updatePropertyAction_"+E})}catch(e){}return t},c="object"===h?function(){return Object.freeze(f(p,this[l],{}))}:function(){return this[l]},Object.defineProperty(e,E,{configurable:!1,enumerable:!0,get:c,set:u(!1)}),b===!0&&v===!0&&Object.defineProperty(e,s,{configurable:!1,enumerable:!1,get:c,set:u(!0)})}}(NationalInstruments.HtmlVI.Elements.NIElement,window.HTMLElement);
NationalInstruments.HtmlVI.Elements.VisualComponent=function(){"use strict"},function(t,e){"use strict";var i=NationalInstruments.HtmlVI.NISupport;i.inheritFromParent(t,e);var a=t.prototype;a.createdCallback=function(){e.prototype.createdCallback.call(this),this._latestSize={width:void 0,height:void 0},this._temporaryModelSettingsHolder=void 0,null===this.getAttribute("data-ni-base-style")&&this.setAttribute("data-ni-base-style","uninitialized")},a.attachedCallback=function(){var t=e.prototype.attachedCallback.call(this),i=this;return t&&(i.setAttribute("data-ni-base-style",""),i.addEventListener("resizeEventHack",function(t){var e=parseInt(t.detail.width),a=parseInt(t.detail.height);i._latestSize.width===e&&i._latestSize.height===a||(i._latestSize.height=a,i._latestSize.width=e,i.forceResize(i._latestSize))})),t},a.forceResize=function(t){}}(NationalInstruments.HtmlVI.Elements.VisualComponent,NationalInstruments.HtmlVI.Elements.NIElement);
NationalInstruments.HtmlVI.Elements.Visual=function(){"use strict"},function(t,e){"use strict";var n=NationalInstruments.HtmlVI.NISupport;n.inheritFromParent(t,e);var s=t.prototype;s.addAllProperties=function(t){e.prototype.addAllProperties.call(this,t),s.addProperty(t,{propertyName:"readOnly",defaultValue:!1})},s.isTextEditFocusable=function(){return!1},s.setFont=function(t,e,n,s,l){this.style.fontSize=t,this.style.fontFamily=e,this.style.fontWeight=n,this.style.fontStyle=s,this.style.textDecoration=l}}(NationalInstruments.HtmlVI.Elements.Visual,NationalInstruments.HtmlVI.Elements.VisualComponent);
