...
The tick labels of the axes are drawn as text on a HTML layer with a CSS class
*"tickLabel"*

Example of 16px, purple tick labels for all axes

```css
ni-cartesian-graph .tickLabel,
ni-chart .tickLabel,
ni-intensity-graph .tickLabel {
    font-family: "Open Sans", verdana, arial, sans-serif;
    font-size: 16px;
    color: purple;
}
...
ni-cartesian-graph .flot-x-axis .tickLabel,
ni-chart .flot-x-axis .tickLabel,
ni-intensity-graph .flot-x-axis .tickLabel {
    margin-left: 5px;
    margin-right: 5px;
}
