...
Webcharts looks are configured using a mix of elements properties, described in this documentation
and CSS styles. The styling with CSS is documented [here in detail](styles.md).
...
**show-ticks** (boolean) - if true the minor tick lines for the axis
