...
Add webcharts to a webpage by including all script files listed in [exampleScripts.json](https://github.com/ni-kismet/webcharts/blob/master/exampleScripts.json).
